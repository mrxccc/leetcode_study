...
<div><div>Related Topics</div><div><li>数组</li><li>双指针</li><li>排序</li></div></div><br><div><li>👍 865</li><li>👎 0</li></div>
*/
/**
 * 有序数组的平方
 *
    ...
    public int[] sortedSquares(int[] nums) {
        ...
        while (left <= right){
            if (nums[left] * nums[left] < nums[right] * nums[right]){
                res[newIndex--] = nums[right] * nums[right];
                right--;
            } else {
                res[newIndex--] = nums[left] * nums[left];
                left++;
            }
        }
        return res;
